...
export const adminService = {
  ...
  verifyOrderItemPrescription: (orderItemId, data) => api.patch(`/admin/orders/items/${orderItemId}/prescription`, data),
  verifyOrderPrescription: (orderId, data) => api.patch(`/admin/orders/${orderId}/prescription/verify`, data),
  getPrescriptions: (params) => api.get('/admin/prescriptions', { params }),
  previewDeletePrescriptionRange: (data) => api.post('/admin/prescriptions/delete-range/preview', data),
  deletePrescriptionRange: (data) => api.delete('/admin/prescriptions/delete-range', { data }),
